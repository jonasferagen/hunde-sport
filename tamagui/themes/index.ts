...
export const lilacTheme = {
    ...
    light_primary_elevated: enhanceTheme(themes.light, lighten(0.15, lilacColor)),
    ...
    dark_primary_elevated: enhanceTheme(themes.dark, lighten(0.15, lilacColor)),
...
export const mintTheme = {
    ...
    light_tertiary_elevated: enhanceTheme(themes.light, lighten(0.15, mintColor)),
    ...
    dark_tertiary_elevated: enhanceTheme(themes.dark, lighten(0.15, mintColor)),
