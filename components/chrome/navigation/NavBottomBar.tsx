...
import { ThemedLinearGradient, ThemedText, ThemedYStack } from "@/components/ui/themed";
import { BOTTOM_BAR_HEIGHT, THEME_BOTTOM_BAR, THEME_PRICE_TAG } from "@/config/app";
...
const CustomBottomBarContents = () => {
  ...
  return (
    <ThemedYStack theme={THEME_BOTTOM_BAR} w="100%" pos="absolute" b={insets.bottom} h={BOTTOM_BAR_HEIGHT}>
      <StyledTabs
        key={currentTab}
