...
const BottomMoreHint = React.forwardRef<BottomMoreHintHandle, Props>(({ enabled, shown, total, idleMs = 600 }, ref) => {
  ...
  return (
    <Animated.View style={[{ position: "absolute", right: 12, bottom: 12, alignItems: "center" }, aStyle]} pointerEvents="box-none">
