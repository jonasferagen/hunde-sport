...
export const LoadingOverlay = React.memo(function LoadingOverlay({ ...props }: StackProps) {
  ...
  return (
    <Animated.View pointerEvents={pe} style={[StyleSheet.absoluteFillObject, { zIndex: 1000, justifyContent: "center", alignItems: "center" }, animStyle]}>
      {/* your content */}
